...
var grokOgIdentity = { "site": {
	...
	"type": "website",
	"card": "custom",
	"description": "Editorial rentals for Bangladesh — find a home, an address, a thikana.",
	"image": "/og.jpg"
} };
//#endregion
...
var _lazy_W4pxgL = defineLazyEventHandler(() => import("./_chunks/ssr-renderer.mjs"));
var findRoute = /* @__PURE__ */ (() => {
	const data = {
		route: "/**",
		handler: _lazy_W4pxgL
	};
	return ((_m, p) => {
		return {
			data,
