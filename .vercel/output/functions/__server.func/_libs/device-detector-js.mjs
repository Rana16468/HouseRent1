...
//#region node_modules/device-detector-js/dist/utils/trim.js
...
//#endregion
//#region node_modules/device-detector-js/dist/utils/version.js
var require_version = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	var trim_1 = require_trim();
	exports.formatVersion = (version, versionTruncation) => {
		if (version === void 0) return "";
		const versionString = trim_1.trim(version, ". ").replace(/* @__PURE__ */ new RegExp("_", "g"), ".");
	...
	exports.parseBrowserEngineVersion = (userAgent, engine) => {
		if (!engine) return "";
		if (engine === "Gecko") {
			const match = userAgent.match(/[ ](?:rv[: ]([0-9\.]+)).*gecko\/[0-9]{8,10}/i);
...
//#endregion
//#region node_modules/device-detector-js/dist/utils/variable-replacement.js
var require_variable_replacement = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.variableReplacement = (template, variables) => {
		const regex = new RegExp(`\\$\\d`, "g");
		if (template === null || template === void 0) return "";
		return template.replace(regex, (match) => {
			return variables[parseInt(match.substr(1), 10) - 1] || "";
		});
	};
}));
//#endregion
//#region node_modules/device-detector-js/dist/utils/memory-cache.js
var require_memory_cache = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.memoryCache = () => {
...
//#endregion
//#region node_modules/device-detector-js/dist/utils/user-agent.js
var require_user_agent = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	var cache = require_memory_cache().memoryCache();
	var getRegexInstance = (rawRegex) => {
		...
		cache.set(rawRegex, { value: regexInstance });
		return regexInstance;
	};
	exports.userAgentParser = (rawRegex, userAgent) => {
		try {
			const match = getRegexInstance(rawRegex).exec(userAgent);
...
//#endregion
//#region node_modules/device-detector-js/dist/parsers/client/fixtures/available-browsers.json
var available_browsers_exports = /* @__PURE__ */ __exportAll({
	A0: () => A0,
	A1: () => A1$1,
	AA: () => AA,
	AB: () => AB,
	...
	ZE: () => ZE,
	ZV: () => "Zvu",
	default: () => available_browsers_default
}), AA, AB, AF, AG, AL, AH, AM, AO, AN, AE, AD, AR, AX, AV, AW, A0, AT, AS, VG, AC, A1$1, BA, BM, BB, BD, BS, BI, BE, BH, BJ, BL, BU, BN, BR, BK, BX, BZ, BY, BF, CA, CL, C6, C0, CC, C4, C2, CD, C1, CX, CE, CF, HC, CH, CI, CK, CM, CN, CO, CB, CW, C3, CP, CR, C5, CY, CS, CT, CG, CZ, CU, CV, DB, DE, DG, DA, DT, DS, DF, DO, DR, DL, DI, DD, EC, EI, EL, EB, EE$1, EZ, EU, EP, ES, FA, FX, F1, FB, FD, FE, FF, FK, FY, FR, FL, FO, FM, FW, FN, FS, FU, GA, GH, GI, GB, GE, GO, HS, HA, HE, HO, HJ, HU, IB, IC, I2, I1, I3, I4, ID, IV, IW, IE, IM, IR, JB, JS, JA, JI, JP, JO, KB, KI, KM, KO, KP, KN, KW, KD, KY, KZ, LB, LF, LG$2, LH, LI, IF, LO, LU, LL, LS, LN, LX, M1, MB, MC, MZ, ME, MF, MI, MO, MU, MS, MN, MT, MX, NM, MY, MR, MW, NW, NR, NB, NO, NV, NX, NE, NF, NL, NP, NS, NT, OC, O1, OB, O2$1, H2, OD, OF, HH, OE, OX, OG, OH, OI, OM, OP, ON, OO, OA, OS, OR, O0, OY, OV, OW, OT, PL, PM, PY, PP, PR, PU, PW, PA, PE, PH, PX, PB, PF, PO, PT, LY, PI, PS, QA, Q2, Q1, QQ, QT, QU, QZ, QM, QW, RE, RK, RM, SB, SA, S8, SC, SE, SF, S5, SW, SV, SH, S1, SY, SK, SS, SL, S6, S7, LE, OZ, SN, SO, S2, SI, SR, SP, SU, S3, SG, S0, S4, ST, SX, SZ, TR, TO, TA, TF, TB, TZ, TU, TG, TS, TV, UB, UC, UH, UM, UT, UR, UZ, VE, VI, VV, VB, VM, WI, WP, WE$1, WF, WH, WO, WT, YJ, YA, YL, YN, YB, XS, XI, XV, ZE, available_browsers_default;
var init_available_browsers = __esmMin((() => {
	AA = "Avant Browser";
	AB = "ABrowse";
	AF = "ANT Fresco";
	AG = "ANTGalio";
...
//#endregion
//#region node_modules/device-detector-js/dist/parsers/client/fixtures/mobile-only-browsers.json
var mobile_only_browsers_exports = /* @__PURE__ */ __exportAll({ default: () => mobile_only_browsers_default });
var mobile_only_browsers_default;
var init_mobile_only_browsers = __esmMin((() => {
	mobile_only_browsers_default = [
		"36",
		"OC",
		"PU",
		"SK",
...
//#endregion
//#region node_modules/device-detector-js/dist/parsers/client/browser.js
var require_browser = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var browsers_json_1 = __importDefault((init_browsers(), __toCommonJS(browsers_exports).default));
	var browser_engine_json_1 = __importDefault((init_browser_engine(), __toCommonJS(browser_engine_exports).default));
	var available_browsers_json_1 = __importDefault((init_available_browsers(), __toCommonJS(available_browsers_exports).default));
	var mobile_only_browsers_json_1 = __importDefault((init_mobile_only_browsers(), __toCommonJS(mobile_only_browsers_exports).default));
	var BrowserParser = class {
		constructor(options) {
			this.options = { versionTruncation: 1 };
	...
	BrowserParser.getBrowserShortName = (browserName) => {
		for (const [shortName, name] of Object.entries(available_browsers_json_1.default)) if (name === browserName) return shortName;
		return "";
	};
...
//#endregion
//#region node_modules/device-detector-js/dist/fixtures/regexes/client/feed_readers.json
var feed_readers_exports = /* @__PURE__ */ __exportAll({ default: () => feed_readers_default });
var feed_readers_default;
var init_feed_readers = __esmMin((() => {
	feed_readers_default = [
		{
			"regex": "Akregator(?:/(\\d+[\\.\\d]+))?",
			"name": "Akregator",
			"version": "$1",
...
//#endregion
//#region node_modules/device-detector-js/dist/parsers/client/feed-readers.js
var require_feed_readers = /* @__PURE__ */ __commonJSMin(((exports) => {
	var __importDefault = exports && exports.__importDefault || function(mod) {
		return mod && mod.__esModule ? mod : { "default": mod };
	};
	Object.defineProperty(exports, "__esModule", { value: true });
	var feed_readers_json_1 = __importDefault((init_feed_readers(), __toCommonJS(feed_readers_exports).default));
	var version_1 = require_version();
	var variable_replacement_1 = require_variable_replacement();
	var user_agent_1 = require_user_agent();
...
//#endregion
//#region node_modules/device-detector-js/dist/fixtures/regexes/client/libraries.json
var libraries_exports = /* @__PURE__ */ __exportAll({ default: () => libraries_default });
var libraries_default;
var init_libraries = __esmMin((() => {
	libraries_default = [
		{
			"regex": "Wget(?:/(\\d+[\\.\\d]+))?",
			"name": "Wget",
...
//#endregion
//#region node_modules/device-detector-js/dist/parsers/client/libraries.js
var require_libraries = /* @__PURE__ */ __commonJSMin(((exports) => {
	var __importDefault = exports && exports.__importDefault || function(mod) {
		return mod && mod.__esModule ? mod : { "default": mod };
	};
	Object.defineProperty(exports, "__esModule", { value: true });
	var libraries_json_1 = __importDefault((init_libraries(), __toCommonJS(libraries_exports).default));
	var version_1 = require_version();
	var variable_replacement_1 = require_variable_replacement();
	var user_agent_1 = require_user_agent();
...
//#endregion
//#region node_modules/device-detector-js/dist/fixtures/regexes/client/mediaplayers.json
var mediaplayers_exports = /* @__PURE__ */ __exportAll({ default: () => mediaplayers_default });
var mediaplayers_default;
var init_mediaplayers = __esmMin((() => {
	mediaplayers_default = [
		{
			"regex": "Audacious(?:[ /]([\\d\\.]+))?",
			"name": "Audacious",
			"version": "$1"
...
//#endregion
//#region node_modules/device-detector-js/dist/parsers/client/media-players.js
var require_media_players = /* @__PURE__ */ __commonJSMin(((exports) => {
	var __importDefault = exports && exports.__importDefault || function(mod) {
		return mod && mod.__esModule ? mod : { "default": mod };
	};
	Object.defineProperty(exports, "__esModule", { value: true });
	var mediaplayers_json_1 = __importDefault((init_mediaplayers(), __toCommonJS(mediaplayers_exports).default));
	var version_1 = require_version();
	var variable_replacement_1 = require_variable_replacement();
	var user_agent_1 = require_user_agent();
...
//#endregion
//#region node_modules/device-detector-js/dist/fixtures/regexes/client/pim.json
var pim_exports = /* @__PURE__ */ __exportAll({ default: () => pim_default });
var pim_default;
var init_pim = __esmMin((() => {
	pim_default = [
		{
...
//#endregion
//#region node_modules/device-detector-js/dist/parsers/client/personal-information-managers.js
var require_personal_information_managers = /* @__PURE__ */ __commonJSMin(((exports) => {
	var __importDefault = exports && exports.__importDefault || function(mod) {
		return mod && mod.__esModule ? mod : { "default": mod };
	};
	Object.defineProperty(exports, "__esModule", { value: true });
	var pim_json_1 = __importDefault((init_pim(), __toCommonJS(pim_exports).default));
	var version_1 = require_version();
	var variable_replacement_1 = require_variable_replacement();
	var user_agent_1 = require_user_agent();
...
//#endregion
//#region node_modules/device-detector-js/dist/parsers/client/index.js
var require_client = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var mobile_apps_1 = __importDefault(require_mobile_apps());
	var feed_readers_1 = __importDefault(require_feed_readers());
	var libraries_1 = __importDefault(require_libraries());
		...
		constructor(options) {
			...
			this.parse = (userAgent) => {
				for (const Parser of clientParsers) {
					const client = new Parser(this.options).parse(userAgent);
...
//#endregion
//#region node_modules/device-detector-js/dist/fixtures/regexes/device/cameras.json
var cameras_exports = /* @__PURE__ */ __exportAll({
	Nikon: () => Nikon,
	Samsung: () => Samsung$4,
	default: () => cameras_default
});
var Nikon, Samsung$4, cameras_default;
var init_cameras = __esmMin((() => {
	Nikon = {
		"regex": "Coolpix S800c",
		"device": "camera",
		"model": "Coolpix S800c"
...
//#endregion
//#region node_modules/device-detector-js/dist/parsers/device/cameras.js
var require_cameras = /* @__PURE__ */ __commonJSMin(((exports) => {
	var __importDefault = exports && exports.__importDefault || function(mod) {
		return mod && mod.__esModule ? mod : { "default": mod };
	};
	Object.defineProperty(exports, "__esModule", { value: true });
	var cameras_json_1 = __importDefault((init_cameras(), __toCommonJS(cameras_exports).default));
	var variable_replacement_1 = require_variable_replacement();
	var user_agent_1 = require_user_agent();
...
//#endregion
//#region node_modules/device-detector-js/dist/fixtures/regexes/device/mobiles.json
var mobiles_exports = /* @__PURE__ */ __exportAll({
	A1: () => A1,
	AGM: () => AGM,
	AIS: () => AIS,
	AMGOO: () => AMGOO,
...
var Ace, SFR, HTC, Microsoft$2, Nokia, CnM, RIM, CHIA, Palm, HP$2, TiPhone, Apple$1, MicroMax, Acteck, Alba, AllCall, Bravis, Acer$2, Advan, Advance, AGM, Airness, Aiwa, Akai, Alcatel, Allview, Allwinner, altron, AMGOO, Amoi, Ainol, Archos$1, Axxion, MEU, Arnova, ARRIS$1, Ask, ANS, AOC$1, Assistant, Ark, Asus$2, Audiovox, AVH, Avvio, BGH, Bitel, Blu, Bluegood, Blackview, Bluboo, bogo, Boway, Brondi, Vivo, Vinsoc, Bird, Becker, Beeline, Beetel, BenQ, Blaupunkt$1, Bmobile, bq, Bush$1, CAGI, Capitel, Captiva, Casio, Casper, Cat, Carrefour, Celkon, Changhong$1, Comio, Compal, Artel, ConCorde, Condor, Coolpad, Clarmin, CORN, Cosmote, Cricket, Crosscall, AllDocube, Cube, CUBOT, Clout, Concord, Crescent, Cyrus, Datang, Datsun, Danew, Denver, Dell$2, Desay, DEXP, Dbtel, Dialog, Dicam, Digi, Digicel, Digiland, Digma, DoCoMo, Doogee, Doov, Dopod, Doro, DNS, Easypix, EBEST, ECS, EE, EKT, Elephone, Element, Elenberg, Ericy, Essential, Evercoss, Eurostar, Eton, Essentielb$1, Facebook, Rikomagic, Rinno, Riviera, Senseit, Sony$3, Ergo, Ericsson, Energizer, eTouch, Etuline, Storex, Evertek, Evolio, Evolveo, Explay, EvroMedia, EKO, Extrem, Ezze, Ezio, Forstar, Foxconn, Fondi, Fairphone, Famoco, FiGO, FNB, Fujitsu$1, Gemini, Geotel, Ghia, Gigabyte, Gigaset, Ginzzu, Gionee, Grape, Vizio, GOCLEVER, GoMobile, Goly, Google, Gradiente, Grundig$1, Hafury, Haier$1, HannSpree, Hasee, Hisense$1, Hoffmann, Homtom, Hosin, Hoozo, Minix, Huawei, Hyundai$1, iBall, iRola, iRulu, Irbis, iBerry, iHunt, IconBIT, LYF, Lumus, M4tel, iLA, iNew, iPro, Infinix, InFocus, InnJoo, Inkti, Innos, Innostream, Insignia, INQ, Intex, iKoMo, iOcean, iView, Impression, iLife, iTel, iZotron, Jiayu, Jolla, Just5, Kalley$1, Kaan, Kazam, Keneksi, Kiano, Kingsun, Kocaso, Kogan, Komu, Koobee, Kumai, KDDI, Kodak, KOPO, Koridy, KRONO, Diva, Kyocera, LAIQ, AIS, Lava, SKG, Landvo, Lanix, Lark, LCT, Leagoo, Ledstar, LeEco, Leotec, Lephone, Lenco, Lenovo$2, Lexand, Lexibook, LG$1, Lingwin, Logicom, Konka, Konrow, Karbonn, Sagem, Mpman, Majestic, Masstel, Maxwest, Maze, Mediacom, Medion$2, MEEG, Fourel, Meizu, Meitu, Memup, Mecer, Mio, Miray$1, Mitsubishi, MIXC, Mobiola, Mobicel, Mobiistar, MSI$1, MLLED, Mobistel, Mecool, Modecom, Mofut, BrightSign, Motorola, Movic, MTN, MyTab, MyPhone, MyWigo, Myros, Myria, Navon, NOA, Nobby, NEC, Neffos, Nextbit, Newgen, Netgear, NeuImage, NextBook, NGM, Nexian, Noain, Noblex, Nomu, Nomi, Nous, Nvidia, O2, Odys, Obi, Okapia, Onda, OnePlus, Realme, OPPO, Opsson, Orange, Oukitel, OKWU, Ouki, Overmax, Oysters, öwn, Panacom, Panasonic$2, PCBOX, PCD, ArmPhone, Pentagram, TCL$1, JVC$1, phoneOne, Primepad, Pioneer, Pixus, PULID, Pomp, PPTV, ProScan, Readboy, Roku, Rokit, Rombica, Rover, RoverPad, Roadrover, Safaricom, Santin, Siemens, Soundmax, Samsung$3, Sanei, Selfix, Sencor, Senwa, Sky, Skyworth$1, Smartfren, Smartisan, STK, Stonex, SuperSonic, Supra, Sumvision, SunVan, SWISSMOBILITY, Thomson$2, Tanix, Pantech, Ployer, Plum, Polaroid$1, PolyPad, Polytron, Positivo, Prestigio, Sanyo, Qilive$1, QMobile, Maximus, Quantum, Quechua, Ramos, Razer, Sendo, Turbo, Sigma, Spice, Sharp$1, Simply, Softbank, Sonim, Star, Starmobile, Amazon, Symphony, Helio, Syrox, Qtek, Teclast, TechPad, Tesco, teXet, Telefunken$1, Telego, Telenor, Telit, ThL, TIANYU, Timovi, Tooky, Tolino, Toplux, Touchmate, TrekStor, Trevi, TVC, Uhappy, Unimax, Unowhy, UTStarcom, Ulefone, UMIDIGI, Uniscope, Unnecto, Unonu, UTOK, Vastking, ViewSonic, Vitelcom, Fengxiang, Vernee, Vertu, Venso, Verizon, Verykool, Vestel$1, Videocon, Vodafone, Vonino, Vorago, Voto, Voxtel, Vulcan, Walton, WellcoM, Wexler, Inco, Wink, Wiko, Wieppo, Weimei, Wileyfox, Wolder, Wolfgang, Wonu, Woo, Woxter, POCO, Xiaomi, Xion, Xolo, Yarvik, Yes, Yezz, Yu, Yuandao, Yusun, Ytone, Zonda, ZYQ, Toshiba$3, Vivax, MLS, Fly, FinePower, Freetel, Zeemi, Zenek, Zopo, ZTE, Zuum, Zen, Zync, Lemhoov, MTC$1, MegaFon, Inoi, Vertex, Unknown, Starway, Savio, Simbans, MYFON, Xiaolajiao, Ritmix, NEXBOX, True, Yandex, FORME, Shuttle, BDF, Highscreen, CVTE, Globex, Atom, Qumo, Umax, Mann, Unihertz, Chuwi, Bezkam, KATV1, Ghong, Xoro, Vinga, Viumee, Nuvo, Sunvell, Ugoos, Yxtel, Proline, Yota, Mystery, Ritzviva, DeWalt, Runbo, NewsMy, Newsday, Daewoo, Vesta, Spectrum, Kivi, Divisat, Kanji, Kaiomy, National, Vsun, RugGear, Aligator, Maxcom, Luna, Protruly, JFone, Uhans, Soyes, Zidoo, Zfiner, iGet, iVA, Phicomm, Huadoo, Gome, Voyo, Ryte, Vontar, Vorke, Wigor, NEXON, ONN, EXO, Datawind, Droxio, Goophone, PocketBook, Bitmore, Kuliao, Sugar, Subor, Xshitou, JKL, Gree, Vodacom, VKworld, Mito, TWM, TWZ, Onix, Oale, Mobo, Macoox, Prixton, Magnus, Newland, Orbic, RED, Contixo, How, Multilaser, Maxtron, Philco, Newman, Swipe, Owwo, Ravoz, Tone, BIHEE, Enot, Kooper, Lesia, Anry, Tinai, Winds, Asano, Phonemax, Vipro, OzoneHD, Kzen, Melrose, Crony, Takara, Tronsmart, Amigoo, Lumigon, Neomi, Eltex, Senkatel, Bobarry, Wortmann, Billion, Tele2, Alfawise, Klipad, SQOOL, TurboKids, Jinga, Twoe, iTruck, Torex, Doffler, Oyyu, Primux, iMars, Logic, Cloudpad, Cloudfone, Vsmart, MiXzo, Openbox, Ziox, iDroid, Aoson, NextTab, Time2, Sunstech, Hotwav, Tetratab, Dolamee, Invin, Doopro, IQM, Nos, Accent, Avenzo, Beelink, MAXVI, meanIT, Kenxinda, Xgody, Alcor, iBrit, Ovvi, Fero, Ruio, Transpeed, VVETIME, A1, Swisstone, iVooMi, Pixelphone, Pixela, Iris, Fonos, Xtouch, Conquest, Zatec, Selenga, Starlight, GEOFOX, Tinmo, Matrix, Verico, TTEC, eSTAR, Hometech, ExMobile, Hipstreet, Navitech, NorthTech, UNIWA, Andowl, Silelis, Bluedot, Reach, MobiWire, Hezire, Hurricane, iSWAG, Reeder, ELARI, Altice, Kult, Beyond, BioRugged, VAIO, Spark, SPC, Winmax, Zebra, Thuraya, Bkav, Brandt, Bigben, SMARTEC, Asanzo, Artizlee, Mintt, Premio, Trifone, Bluewave, Siragon, Poppox, Zentality, Fortis, OpelMobile, NuAns, Koolnee, Sansui, Sico, Smadl, EXCEED, Tymes, Solone, FarEasTone, Smailo, Colors, Honeywell, Electroneum, Pluzz, IUNI, Ordissimo$1, Necnot, Einstein, AfriOne, Connex, Connectce, Clementoni, VC, CellAllure, Eagle, Invens, Claresta, Camfone, Bellphone, Gini, MIVO, Jesy, Teknosa, Hyve, EWIS, Cavion, GLX, Seeken, Jivi, Winnovo, WE, Trio, Seuic, Centric, Kata, Leff, Hardkernel, Wiseasy, BBK, Westpoint, Wintouch, Aiuto, Seatel, Ditecma, Datamini, Formuler, Malata, IT, Navcity, Jiake, Mantra, Datalogic, Navitel, Linnex, Smartab, SuperTab, Suzuki, Philips$1, INCAR, Nabi, StrawBerry, Gresso, Pendoo, PiPO, Engel, Genesis, InfoKit, Blloc, Huskee, SOLE, SOLO, OINOM, Singtech, Sunny, TEENO, OASYS, Aspera, NOBUX, Hitech, F150, BilimLand, Greentel, Kyowon, GFive, KINGZONE, Fantec, AURIS, YUHO, mobiles_default;
var init_mobiles = __esmMin((() => {
	Ace = {
...
//#endregion
//#region node_modules/device-detector-js/dist/utils/model.js
var require_model = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
...
//#endregion
//#region node_modules/device-detector-js/dist/parsers/device/mobiles.js
var require_mobiles = /* @__PURE__ */ __commonJSMin(((exports) => {
	var __importDefault = exports && exports.__importDefault || function(mod) {
		return mod && mod.__esModule ? mod : { "default": mod };
	};
	Object.defineProperty(exports, "__esModule", { value: true });
	var mobiles_json_1 = __importDefault((init_mobiles(), __toCommonJS(mobiles_exports).default));
	var variable_replacement_1 = require_variable_replacement();
	var user_agent_1 = require_user_agent();
...
//#endregion
//#region node_modules/device-detector-js/dist/fixtures/regexes/device/televisions.json
var televisions_exports = /* @__PURE__ */ __exportAll({
	AOC: () => AOC,
	ARRIS: () => ARRIS,
	Airties: () => Airties,
	Atvio: () => Atvio,
	...
	default: () => televisions_default
});
var Airties, AOC, ARRIS, Atvio, BangOlufsen, Blaupunkt, Bush, Celcus, Changhong, CreNova, Digihome, DMM, ELECTRONIA, Essentielb, Finlux, Fuego, GoGEN, Grundig, Haier, Hisense, Hitachi, Horizon, Hotel, Humax, Hyundai, Ikea, Intek, Inverto, JVC, Kalley, KUBO, Laurus, LG, Lifemaxx, Linsar, Loewe, Luxor, Manhattan, MediaTek, Medion$1, Miray, MStar, MTC, Nordmende, Metz, Ok, Panasonic$1, PEAQ, Philips, Polaroid, PROFiLO, Qilive, REGAL, Saba, Salora, Samsung$2, SCBC, SEG, Selevision, Sharp, Skyworth, Smart, Sony$2, SWTV, Technicolor, Technika, TechniSat, TechnoTrend, Techwood, Telefunken, TCL, Thomson$1, TOKYO, Toshiba$2, Videoweb, VOX, WELLINGTON, Vestel, televisions_default;
var init_televisions = __esmMin((() => {
	Airties = {
		"regex": "Airties",
		"device": "tv",
		"models": [{
...
//#endregion
//#region node_modules/device-detector-js/dist/parsers/device/televisions.js
var require_televisions = /* @__PURE__ */ __commonJSMin(((exports) => {
	var __importDefault = exports && exports.__importDefault || function(mod) {
		return mod && mod.__esModule ? mod : { "default": mod };
	};
	Object.defineProperty(exports, "__esModule", { value: true });
	var televisions_json_1 = __importDefault((init_televisions(), __toCommonJS(televisions_exports).default));
	var variable_replacement_1 = require_variable_replacement();
	var user_agent_1 = require_user_agent();
	var model_1 = require_model();
...
//#endregion
//#region node_modules/device-detector-js/dist/fixtures/regexes/device/car_browsers.json
var car_browsers_exports = /* @__PURE__ */ __exportAll({
	Tesla: () => Tesla,
	Topway: () => Topway,
	default: () => car_browsers_default
});
var Tesla, Topway, car_browsers_default;
var init_car_browsers = __esmMin((() => {
	Tesla = {
...
//#endregion
//#region node_modules/device-detector-js/dist/parsers/device/cars.js
var require_cars = /* @__PURE__ */ __commonJSMin(((exports) => {
	var __importDefault = exports && exports.__importDefault || function(mod) {
		return mod && mod.__esModule ? mod : { "default": mod };
	};
	Object.defineProperty(exports, "__esModule", { value: true });
	var car_browsers_json_1 = __importDefault((init_car_browsers(), __toCommonJS(car_browsers_exports).default));
	var variable_replacement_1 = require_variable_replacement();
	var user_agent_1 = require_user_agent();
	var CarParser = class {
		constructor() {
			this.parse = (userAgent) => {
				...
				for (const [brand, car] of Object.entries(car_browsers_json_1.default)) {
					if (!user_agent_1.userAgentParser(car.regex, userAgent)) continue;
					result.type = "car";
					result.brand = brand;
...
//#endregion
//#region node_modules/device-detector-js/dist/fixtures/regexes/device/consoles.json
var consoles_exports = /* @__PURE__ */ __exportAll({
	Archos: () => Archos,
	...
	Sega: () => Sega,
	Sony: () => Sony$1,
	default: () => consoles_default
});
var Archos, Microsoft$1, Nintendo, OUYA, Sega, Sony$1, consoles_default;
var init_consoles = __esmMin((() => {
	Archos = {
...
//#endregion
//#region node_modules/device-detector-js/dist/parsers/device/consoles.js
var require_consoles = /* @__PURE__ */ __commonJSMin(((exports) => {
	var __importDefault = exports && exports.__importDefault || function(mod) {
		return mod && mod.__esModule ? mod : { "default": mod };
	};
	Object.defineProperty(exports, "__esModule", { value: true });
	var consoles_json_1 = __importDefault((init_consoles(), __toCommonJS(consoles_exports).default));
	var variable_replacement_1 = require_variable_replacement();
	var user_agent_1 = require_user_agent();
...
//#endregion
//#region node_modules/device-detector-js/dist/fixtures/regexes/device/notebooks.json
var notebooks_exports = /* @__PURE__ */ __exportAll({
	Acer: () => Acer$1,
	Asus: () => Asus$1,
	Dell: () => Dell$1,
	HP: () => HP$1,
...
var Acer$1, Asus$1, Dell$1, HP$1, Lenovo$1, Schneider, Thomson, Toshiba$1, notebooks_default;
var init_notebooks = __esmMin((() => {
	Acer$1 = {
...
//#endregion
//#region node_modules/device-detector-js/dist/parsers/device/notebooks.js
var require_notebooks = /* @__PURE__ */ __commonJSMin(((exports) => {
	var __importDefault = exports && exports.__importDefault || function(mod) {
		return mod && mod.__esModule ? mod : { "default": mod };
	};
	Object.defineProperty(exports, "__esModule", { value: true });
	var notebooks_json_1 = __importDefault((init_notebooks(), __toCommonJS(notebooks_exports).default));
	var variable_replacement_1 = require_variable_replacement();
	var user_agent_1 = require_user_agent();
	var model_1 = require_model();
	var NotebooksParser = class {
		constructor() {
			this.parse = (userAgent) => {
				const result = {
					type: "",
...
//#endregion
//#region node_modules/device-detector-js/dist/fixtures/regexes/device/portable_media_player.json
var portable_media_player_exports = /* @__PURE__ */ __exportAll({
	Apple: () => Apple,
	Cowon: () => Cowon,
	Microsoft: () => Microsoft,
	Panasonic: () => Panasonic,
	...
	Samsung: () => Samsung$1,
	Wizz: () => Wizz,
	default: () => portable_media_player_default
});
var Apple, Cowon, Microsoft, Panasonic, Samsung$1, Wizz, SONOS, portable_media_player_default;
var init_portable_media_player = __esmMin((() => {
	Apple = {
		"regex": "(?:Apple-)?iPod",
		"device": "portable media player",
		"models": [
...
//#endregion
//#region node_modules/device-detector-js/dist/parsers/device/portable-media-players.js
var require_portable_media_players = /* @__PURE__ */ __commonJSMin(((exports) => {
	var __importDefault = exports && exports.__importDefault || function(mod) {
		return mod && mod.__esModule ? mod : { "default": mod };
	};
	Object.defineProperty(exports, "__esModule", { value: true });
	var portable_media_player_json_1 = __importDefault((init_portable_media_player(), __toCommonJS(portable_media_player_exports).default));
	var variable_replacement_1 = require_variable_replacement();
	var user_agent_1 = require_user_agent();
...
//#endregion
//#region node_modules/device-detector-js/dist/parsers/device/index.js
var require_device = /* @__PURE__ */ __commonJSMin(((exports) => {
	var __importDefault = exports && exports.__importDefault || function(mod) {
		return mod && mod.__esModule ? mod : { "default": mod };
	};
	Object.defineProperty(exports, "__esModule", { value: true });
	var cameras_1 = __importDefault(require_cameras());
	var mobiles_1 = __importDefault(require_mobiles());
	var televisions_1 = __importDefault(require_televisions());
	var cars_1 = __importDefault(require_cars());
	var consoles_1 = __importDefault(require_consoles());
	var notebooks_1 = __importDefault(require_notebooks());
		...
		constructor() {
			this.parse = (userAgent) => {
				for (const Parser of deviceParsers) {
					const device = new Parser().parse(userAgent);
...
//#endregion
//#region node_modules/device-detector-js/dist/parsers/operating-system/index.js
var require_operating_system = /* @__PURE__ */ __commonJSMin(((exports) => {
	var __importDefault = exports && exports.__importDefault || function(mod) {
		return mod && mod.__esModule ? mod : { "default": mod };
	};
	Object.defineProperty(exports, "__esModule", { value: true });
	var oss_json_1 = __importDefault((init_oss(), __toCommonJS(oss_exports).default));
	var version_1 = require_version();
	var variable_replacement_1 = require_variable_replacement();
	var user_agent_1 = require_user_agent();
	var operating_system_json_1 = __importDefault((init_operating_system(), __toCommonJS(operating_system_exports).default));
	var desktopOsArray = [
		"AmigaOS",
		"IBM",
		"GNU/Linux",
	...
	OperatingSystemParser.getOsFamily = (osName) => {
		...
		for (const [osFamily, shortNames] of Object.entries(osFamilies)) if (shortNames.includes(osShortName)) return osFamily;
		return "";
	};
	OperatingSystemParser.getOsShortName = (osName) => {
		for (const [shortName, name] of Object.entries(shortOsNames)) if (name === osName) return shortName;
		return "";
	};
}));
//#endregion
//#region node_modules/device-detector-js/dist/fixtures/regexes/vendorfragments.json
var vendorfragments_exports = /* @__PURE__ */ __exportAll({
	Acer: () => Acer,
	Asus: () => Asus,
	Compaq: () => Compaq,
	Dell: () => Dell,
	...
	Sony: () => Sony,
	Toshiba: () => Toshiba,
	default: () => vendorfragments_default
});
var Dell, Acer, Sony, Asus, Samsung, Lenovo, Toshiba, Medion, MSI, Gateway, Fujitsu, Compaq, HP, Hyrican, Ordissimo, vendorfragments_default;
var init_vendorfragments = __esmMin((() => {
	Dell = [
		"MDDR(JS)?",
		"MDDC(JS)?",
		"MDDS(JS)?"
	...
	Hyrican = ["MANM(JS)?"];
	Ordissimo = ["Ordissimo", "webissimo3"];
	vendorfragments_default = {
		Dell,
		Acer,
		Sony,
		Asus,
...
//#endregion
//#region node_modules/device-detector-js/dist/parsers/vendor-fragment/index.js
var require_vendor_fragment = /* @__PURE__ */ __commonJSMin(((exports) => {
	var __importDefault = exports && exports.__importDefault || function(mod) {
		return mod && mod.__esModule ? mod : { "default": mod };
	};
	Object.defineProperty(exports, "__esModule", { value: true });
	var vendorfragments_json_1 = __importDefault((init_vendorfragments(), __toCommonJS(vendorfragments_exports).default));
	var user_agent_1 = require_user_agent();
		...
		constructor() {
			this.parse = (userAgent) => {
				for (const [brand, vendorFragment] of Object.entries(vendorfragments_json_1.default)) for (const regex of vendorFragment) {
					if (!user_agent_1.userAgentParser(regex, userAgent)) continue;
					return brand;
				}
				return "";
			};
		...
		constructor() {
			this.parse = (userAgent) => {
				...
				for (const bot of bots_json_1.default) {
					if (!user_agent_1.userAgentParser(bot.regex, userAgent)) continue;
					return {
						name: bot.name,
...
//#endregion
//#region node_modules/device-detector-js/dist/utils/version-compare.js
var require_version_compare = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
...
//#endregion
//#region node_modules/device-detector-js/dist/index.js
		...
		constructor(options) {
			...
			this.parse = (userAgent) => {
				...
				*/
				...
				if ("desktop" !== ((_o = result.device) === null || _o === void 0 ? void 0 : _o.type) && null !== user_agent_1.userAgentParser("Desktop", userAgent) && this.hasDesktopFragment(userAgent)) {
					if (!result.device) result.device = this.createDeviceObject();
