...
/**
 * Bangladesh location data: Division -> District -> Thana -> Area
 *
 * Generated from the authenticated District -> Thana source data (all
 * district and thana names preserved exactly, including known duplicate
 * thana names across districts, non-standard spellings, and district-name
 * variants like 'Dhaka City' / 'Dhaka Sub-Urban'). Division assignment
 * follows Bangladesh's 8 official administrative divisions.
 *
 * Area data is the same PLACEHOLDER sample data as the source
 * (District > Thana keyed) -- not real neighborhood data. Swap it out
 * once you have a real source.
 */
